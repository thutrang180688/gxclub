  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <main className="flex-1 max-w-[1440px] mx-auto w-full px-0 sm:px-4 py-4 lg:py-8 pb-12">
        ...
        {/* --- PHẦN FOOTER CHUẨN --- */}
        <footer 
  className="mt-24 px-6 py-12 text-white rounded-t-[3rem]" 
  style={{ 
    backgroundColor: '#042f2e', // Chính xác là màu teal-950
    isolation: 'isolate',        // CỰC KỲ QUAN TRỌNG: Ngăn logo hòa trộn với nền slate-50 của trang
    position: 'relative'
  }}
>
    ...
    <div>
      <div className="flex items-center justify-center md:justify-start">
        <img 
          ...
          style={{ 
            mixBlendMode: 'screen', // Ép các pixel trắng hiển thị chuẩn và bỏ qua viền mờ
            filter: 'contrast(1.1)'  // Tăng độ đanh cho logo
          }}
          loading="eager"
        />
      </div>
